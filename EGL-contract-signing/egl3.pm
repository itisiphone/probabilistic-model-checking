...
module scheduler
	...
	[receiveA] phase=2 & party=2 & n=N-1 & b<L -> (phase'=2) & (party'=1) & (n'=0) & (b'=b+1);	
	...
	[receiveA] phase=3 & party=2 & n=N-1 & b<L -> (phase'=3) & (party'=1) & (n'=0) & (b'=b+1);	

	// B sends final (Lth) bit of 2Nth secret, move to next phase and back to A
